...
export function FinalSurprise({
  ...
  return (
    ...
    >
      {/* Background effects after reveal */}
      {revealed && (
        <div
          aria-hidden
          ...
          {sparks.map((s, i) => (
            <span
              ...
              style={{
                ...
                height: s.size,
                boxShadow:
                  "0 0 10px oklch(0.85 0.148 88 / 0.9)",
              ...
              style={
                {
                  ...
                  "--drift": `${f.drift}vw`,
                  fontSize:
                    f.kind === "heart" ? "1.1rem" : "0.95rem",
                  filter:
                    "drop-shadow(0 0 10px oklch(0.66 0.212 0.5 / 0.6))",
